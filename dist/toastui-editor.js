...
function createMarkdownToHTML(options) {
  var renderHTML = Object(toastmark["createRenderHTML"])({
    gfm: true,
    convertors: Object(htmlRenderConvertors["a" /* getHTMLRenderConvertors */])(null, options.customHTMLRenderer)
  });
